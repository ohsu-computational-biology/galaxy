...
HDFS_INPUT_PATH_FILE=/user/vijaym/adam//dbsnp_132.vcf
HDFS_OUTPUT_PATH_FILE=/user/vijaym/adam//dbsnp_132.var.adam
SEARCH='//'
...
iferr=$(export SPARK_HOME=/opt/cloudera/parcels/CDH-5.4.4-1.cdh5.4.4.p0.4/lib/spark; /opt/adam/adam-distribution-0.16.0/bin/adam-submit --conf spark.shuffle.service.enable=true --master yarn-client vcf2adam $HDFS_INPUT_PATH_FILE $HDFS_OUTPUT_PATH_FILE -onlyvariants 2>&1)
