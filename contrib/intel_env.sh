...
export http_proxy=http://sparkdmz1.spark0.intel.com:4000
export https_proxy=${http_proxy}
export ftp_proxy=${http_proxy}
export no_proxy=cluster3.ccc.com,.cluster3.ccc.com,intel.com,.intel.com,10.0.0.0/8,192.168.0.0/16,spark0.intel.com,localhost,127.0.0.0/24,134.134.0.0/16
